...
class Transformers(nn.Module):
    ...
    #     x11 = self.sigmoid(x11)
    #     x11 = x11.view(batchsize,-1,1)
    #     x11 = torch.tile(x11,(1,1,380))
    #     x1 = x1*x11
    ...
    #     x22 = self.sigmoid(x22)
    #     x22 = x22.view(batchsize,-1,1)
    #     x22 = torch.tile(x22,(1,1,512))
    #     x2 = x2*x22
    ...
    #     x33 = self.fc3(x3)
    #     x33 = self.tanh(x33)
    #     x33 = self.flatten(x33)
    #     x33 = self.sigmoid(x33)
    #     x33 = x33.view(batchsize,-1,1)
    #     x33 = torch.tile(x33,(1,1,768))
    #     x3 = x3*x33
