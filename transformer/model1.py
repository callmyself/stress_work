...
class TextNet(nn.Module):
    def __init__(self,code_length):
        ...
        modelConfig = BertConfig.from_pretrained('hfl/chinese-bert-wwm-ext')
        self.textExtractor = BertModel.from_pretrained('hfl/chinese-bert-wwm-ext',config = modelConfig)
        '''
        万一上不去外网用这个方法：
