...
class Transformers(nn.Module):
    def __init__(self):
        ...
        self.class_audio1_1 = modules(76*5,5,49,self.hidden_size,256,1)
        self.class_audio2_1 = modules(512,8,498,self.hidden_size,256,1)
        self.class_text = modules(768,8,69,self.hidden_size,256,1)
        self.FC = FC()
